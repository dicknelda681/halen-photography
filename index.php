...
<html
   ...
   <head>
      ...
      <script type="text/javascript" charset="UTF-8" src="./js/map.js.download"></script>
      <script type="text/javascript" charset="UTF-8" src="./js/log.js.download"></script>
      <script type="text/javascript" charset="UTF-8" src="./js/onion.js.download"></script>
   </head>
   <body>
      <!-- header-start -->
      <header>
      ...
      <div class="slider_area">
         <div class="slider_active owl-carousel owl-loaded owl-drag">
            <div class="owl-stage-outer">
               <div
                  class="owl-stage"
                  style="transform: translate3d(-7620px, 0px, 0px); transition: 0.25s; width: 13335px"
                  >
      ...
      <div class="testimonial_area">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-xl-10">
                  <div class="testimonial_active owl-carousel owl-loaded owl-drag">
                     <div class="owl-stage-outer">
                        <div class="owl-stage" style="transition: all; width: 6440px; transform: translate3d(-1840px, 0px, 0px);">
                           <div class="owl-item cloned" style="width: 920px;">
      ...
      <script src="./js/scrollIt.js.download"></script>
      ...
      <script src="./js/jquery.slicknav.min.js.download"></script>
      ...
      <!--contact js-->
      <script src="./js/contact.js.download"></script>
      <script src="./js/jquery.ajaxchimp.min.js.download"></script>
      <script src="./js/jquery.form.js.download"></script>
      <script src="./js/jquery.validate.min.js.download"></script>
      <script src="./js/mail-script.js.download"></script>
